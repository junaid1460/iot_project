...
//change to your own video
    ...
    cl2[0].x = 3;
    cl2[0].y = intHorizontalLinePosition1;

    cl2[1].x = imgFrame1.cols - 4;
    cl2[1].y = intHorizontalLinePosition1;
...
//CHECKING WHETHER BLOB CROSSED THE LINE
       ...
       if (BlobOnBottomLine == true) {
            cv::line(imgFrame2Copy, cl2[0], cl2[1], SCALAR_GREEN, 2);
        }
        else {
